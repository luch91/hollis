...
const howHollisWorks: DocumentationPage = {
  ...
  sections: [
      ...
      content: (
        <>
          ...
          <ol>
            ...
            <li>Enter the policy title, stable policy ID, and version.</li>
            <li>
              Upload the approved policy source document. Hollis accepts PDF, DOCX, Markdown, and
          ...
          <Note title="What Hollis records">
            <p>
              Hollis validates the uploaded file, calculates its SHA-256 digest, and stores the
              source document privately within the workspace boundary. The digest identifies the
              document used. It does not prove that the policy is lawful, complete, or suitable.
            </p>
          </Note>
          <InterfaceReference
          ...
          >
            <div className="docs-shot-grid">
              ...
              <div>
                ...
                <Field label="Policy source document">release-governance.pdf</Field>
                <Field label="Integrity digest">Generated by Hollis</Field>
    ...
    },
    {
      ...
      title: "7. Independent attestation",
      content: (
        <>
          <WorkflowProgress active={7} />
          <p>
            After human review is complete, Hollis automatically prepares a privacy-safe
            adjudication case file when the policy control and evidence requirements are met. The
            file binds the declared policy control, managed evidence references, human decision, and
            case commitment for GenLayer Studio Next evaluation.
          </p>
          <ol>
            <li>
              Open the completed case and locate <strong>Process attestation</strong> to follow its
              recorded progress.
            </li>
            <li>Confirm that human decision, policy binding, and managed evidence are ready.</li>
            <li>
              Hollis generates the controlled public case file through its configured publisher.
            </li>
            <li>
              Hollis submits the exact commitment and file URL through the active managed
              policy-control contract.
            </li>
            <li>Wait for the recorded status to progress from pending to finalized.</li>
            <li>Confirm the verdict, commitment, and persisted receipt in Hollis.</li>
          </ol>
...
const pages: Record<string, DocumentationPage> = {
    ...
    sections: [
      {
        ...
        content: (
          <>
            <p>
              A published policy records a title, stable policy ID, version, source-document
              metadata, SHA-256 digest, publication time, and publisher. Hollis calculates the
              digest from the approved uploaded document. Create a new version when the governing
              document changes.
            </p>
          </>
        ),
      ...
      },
      {
        ...
        content: (
          <>
            <p>
              Only workspace owners and administrators can publish. Upload the approved source
              document and confirm its title, version, and first control before publication. Hollis
              validates the document and calculates its digest. A published record is immutable so
              historical cases keep their original binding.
            </p>
          </>
        ),
      },
  ...
  "genlayer-attestations": {
    ...
    sections: [
        ...
        content: (
          <>
            <ul>
              ...
              <li>
                Hollis has a configured public publisher and an active managed contract for the
      ...
      {
        id: "automatic-flow",
        title: "Automatic submission and receipt",
        content: (
          <>
            <p>
              No workspace member needs a wallet, a Studio action, or a transaction-hash entry.
              Hollis records the human decision first, creates the public-safe case file, submits
              the exact commitment through the active policy-control contract, and persists the
              final receipt only after it verifies the contract, commitment, finalized status, and
              retained result.
            </p>
          </>
        ),
      ...
      {
        id: "outcomes",
        title: "Reading an outcome",
        content: (
          <>
            <dl className="docs-definition-list">
              <div>
                <dt>Pass</dt>
                <dd>The contract found that the declared process requirements were satisfied.</dd>
              </div>
              <div>
                <dt>Fail</dt>
                <dd>The contract found that a declared process requirement was not satisfied.</dd>
              </div>
              <div>
                <dt>Needs review</dt>
                <dd>The declared facts did not support a conclusive process outcome.</dd>
              </div>
              <div>
                <dt>Undetermined</dt>
                <dd>The attestation has not reached a final process result.</dd>
              </div>
            </dl>
          </>
        ),
          ...
          <>
            <dl className="docs-definition-list">
              ...
              <div>
                ...
                <dd>
                  Do not submit another transaction or enter a transaction hash. Preserve the
                  recorded state and ask an authorized workspace administrator to investigate the
                  managed attestation record.
                </dd>
              </div>
              <div>
                <dt>Undetermined</dt>
    ...
    sections: [
      ...
      },
      {
        ...
        content: (
          <>
            <p>
              Raw evidence and uploaded policy source documents are stored through the configured
              private object-storage provider. PostgreSQL stores tenant-scoped metadata and
              integrity references. A public attestation case file is created only through the
              controlled workflow and excludes raw evidence, personal data, and policy-document
              content by design.
            </p>
          </>
        ),
    ...
    sections: [
      ...
      },
      {
        ...
        content: (
          <>
            <p>
              Evidence and policy source documents use a provider-neutral private storage boundary,
              object-specific signed access, integrity digests, metadata verification, retention
              controls, and legal holds. Sensitive material is excluded from public attestations.
            </p>
          </>
        ),
      },
      ...
      },
      {
        ...
        content: (
          <>
            <p>
              The current evaluation release has a verified managed attestation path, but it still
              requires broader provider acceptance coverage, recovery exercises, a shared limiter
              for multi-instance deployment, and independent security testing before commercial
