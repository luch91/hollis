...
> This is an archival record of the former Google Cloud deployment preflight. It references retired WorkOS and Cloud Run assumptions and must not be used to deploy the active product. It is retained only to preserve the history of prior infrastructure checks. The current deployment contract is [deployment.md](deployment.md), and the current evaluation boundary is [release-readiness-2026-09-16.md](release-readiness-2026-09-16.md).
